...
for f in range(len(files_list)): #Range starts from 0 to n-1)
    ...
    # Process Axis bank statement file
       ...
       f.close()
       #return
    elif '70109082' in file_name:
    # Process HDFC bank statement file
         #def processHdfcBankStatement():
       ...
       print("Invalid File Input ! : " + file_name)
#===================================================================================================
